  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <link type="text/css" rel="stylesheet" href="/InputFiles/XML/treeviewBW.css"/>
      </head>
      <body>
        ...
        In SimRoot parameters can be a single value, a value drawn from a distribution, or the result of an interpolation table.<br/></span>  
...
<!--write the ascii tree lines using the ascii art hierarchy template-->
    <br/>
